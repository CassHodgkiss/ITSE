...
namespace ATM
{
    public partial class MainOptions : Form
    {
        ...
        void SwitchLanguage()
        {
            Prompt_L.Text = LanguageSwitcher.GetString("MainOptions_Prompt");
            Logout_B.Text = LanguageSwitcher.GetString("MainOptions_Logout");
            ViewAccount_B.Text = LanguageSwitcher.GetString("MainOptions_ViewAccount");
            WithdrawDeposit_B.Text = LanguageSwitcher.GetString("MainOptions_WithdrawDeposits");
            Transfer_B.Text = LanguageSwitcher.GetString("MainOptions_Transfer");
            ViewStatement_B.Text = LanguageSwitcher.GetString("MainOptions_ViewStatement");
